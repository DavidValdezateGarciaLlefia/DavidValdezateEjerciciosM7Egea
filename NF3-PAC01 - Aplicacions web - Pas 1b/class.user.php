...
class User {
        ...
        public function Save() {
                if (isset($this->ID)) {
                        ...
                        $log->logMessage('Guardado objeto con id: ' .$this->ID, Logger::INFO);
        ...
        public function MarkForDeletion() {
                ...
                $log = Logger::getInstance();
                $log->logMessage('Marcado objeto para borrar ' .$this->ID, Logger::NOTICE);
        ...
        public function __destruct() {
                if (isset($this->ID)) {
                        if ($this->blForDeletion == true) {
                                ...
                                $objStatement->execute();
                                $log = Logger::getInstance();
                                $log->logMessage('Eliminado objeto con id: ' .$this->ID, Logger::CRITICAL);
                ...
                if (property_exists($this, $strMember)) {
                        if (is_numeric($strNewValue)) {
                                eval('$this->' . $strMember .
                                     ' = ' . $strNewValue . ';');
                                     $log = Logger::getInstance();
                                     $log->logMessage('Valor de objeto numerico puesto', Logger::ERROR);
                                ...
                                eval('$this->' . $strMember .
                                     ' = "' . $strNewValue . '";');
                                     $log = Logger::getInstance();
                                     $log->logMessage('Valor de objeto string puesto', Logger::DEBUG);
        ...
        private function GetAccessor($strMember) {
                if (property_exists($this, $strMember)) {
                        ...
                        $log = Logger::getInstance();
                        $log->logMessage('Valor de objeto obtenido', Logger::NOTICE);
