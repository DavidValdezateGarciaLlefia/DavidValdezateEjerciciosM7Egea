...
class User {
        ...
        public function Save() {
                if (isset($this->ID)) {
                        ...
                        $objStatement->execute();
                        logMessage('Guardado objeto con id: ' .$this->ID.'\n', 75);
                } else {
                        $strValueList = "";
        ...
        public function MarkForDeletion() {
                ...
                logMessage('Marcado objeto para borrar \n', 75);
        }
        ...
        public function __destruct() {
                if (isset($this->ID)) {
                        if ($this->blForDeletion == true) {
                                ...
                                $objStatement->execute();
                                logMessage('Eliminado objeto con id: ' .$this->ID.'\n', 5);
                        };
                }
        }
        ...
        private function SetAccessor($strMember, $strNewValue) {
                if (property_exists($this, $strMember)) {
                        if (is_numeric($strNewValue)) {
                                eval('$this->' . $strMember .
                                     ' = ' . $strNewValue . ';');
                                     logMessage('Valor de objeto numerico puesto \n', 10);
                        } else {
                                eval('$this->' . $strMember .
                                     ' = "' . $strNewValue . '";');
                                     logMessage('Valor de objeto string puesto \n', 100);
                        };
                } else {
                        return(false);
                };
        ...
        private function GetAccessor($strMember) {
                if (property_exists($this, $strMember)) {
                        ...
                        logMessage('Valor de objeto obtenido \n', 50);
                        return($strRetVal);
                } else {
                        return(false);
                };
