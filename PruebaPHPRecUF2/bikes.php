...
class Bike {
    ...
    public function __toString() {
        return "Nombre: " . $this->getNombre() . ", Cambios: " . $this->getGear();
    }
}
...
class Delivery extends Bike {
    ...
    public function __toString() {
        return parent::__toString() . ", Delivery Nombre: " . $this->getNombreDelivery() . ", Delivery Número: " . $this->getNumeroDelivery();
    }
}
...
class Urban extends Bike {
    ...
    public function __toString() {
        return parent::__toString() . ", Urban Nombre: " . $this->getNombreUrban() . ", Urban Número: " . $this->getNumeroUrban();
    }
}
